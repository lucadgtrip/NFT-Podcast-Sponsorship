    ...
    */
    ...
    contract Web3InTravelNFTTicket is ERC721Enumerable, ReentrancyGuard, Ownable {
        ...
        string constant private SPONSOR = "ACTIVE SPONSOR: ";
        ...
        function tokenURI(uint256 _tokenId) override public view returns (string memory) {
           ...
           // string memory _details_type = airdrop[_tokenId] ? TYPE_AIRDROP : TYPE_STANDARD;
            ...
            parts[3] = string(abi.encodePacked('<text x="10" y="200" class="b">Donated: 0.00',toString(prices[_tokenId] / 100000000000000 ),' ETH</text><text x="10" y="220" class="b">By: 0x',toAsciiString(mintedBy[_tokenId]),'</text><text x="10" y="230" class="b"></text>'));

            parts[4] = string(abi.encodePacked('<text x="175" y="250" class="b" text-anchor="middle" >',details[DET_SPONSOR_QUOTE_LONG],'</text><text x="175" y="300" text-anchor="middle" class="c">',details[DET_CREDITS],'</text>',details[DET_LOGO],'</svg>'));
...
//             parts[3] = string(abi.encodePacked('<text x="10" y="220" class="b">This NFT certifies that</text><text x="10" y="240" class="b">Donated: 0.00',toString(prices[_tokenId] / 100000000000000 ),' ETH to the Podcast</text><text x="10" y="260" class="b">"',toAsciiString(mintedBy[_tokenId]),'"'));

//             parts[4] = string(abi.encodePacked('<text x="175" y="260" class="b" text-anchor="middle" >',details[DET_SPONSOR_QUOTE_LONG],'</text><text x="175" y="320" text-anchor="middle" class="c">',details[DET_CREDITS],'</text>',details[DET_LOGO],'</svg>'));
